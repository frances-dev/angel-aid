                        ...
                        <Nav className='my-nav'>
                            {
                                user.name ?
                                    <div className='nav-div d-flex align-items-center'>
                                        ...
                                        <h3 className='text-light small mt-2 pe-3 ms-3'>{user.name}</h3>
                                        <button className="btn-warning ps-3 pe-3 pt-1 pb-1 border-0 rounded-2" onClick={logOut}>Sign Out</button>
                                    </div> :
